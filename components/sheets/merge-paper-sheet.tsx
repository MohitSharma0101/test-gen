  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="p-0">
        <div className="text-base font-medium px-2 py-3 bg-gray-200">Merge Papers</div>
        <div className="p-2 overflow-auto flex flex-col gap-2">
          ...
          <div className="flex gap-2 items-center">
            <Button disabled={disabled} onClick={onSubmit} className="w-fit mt-2" size={"sm"}>
              Merge
            </Button>
            <Button onClick={onClear} className="w-fit mt-2" variant={"outline"} size={"sm"}>
              Clear
            </Button>
          </div>
        </div>
